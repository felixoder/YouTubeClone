...
<main className="container my-2 ">
  ...
  <div className="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div className="col-md-6 px-0">
      <h1 className="display-4 fst-italic">Welcome to </h1>
  ...
  <div className="row g-5">
    <div className="col-md-12">
      ...
      <article className="blog-post">
        ...
        <p>HTML defines a long list of available inline tags, a complete list of which can be found on the <Link to="https://developer.mozilla.org/en-US/docs/Web/HTML/Element">Mozilla Developer Network</Link>.</p>
        <ul>
